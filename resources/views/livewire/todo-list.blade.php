            ...
            <div>
                ...
                @else
                    <div class="flex">
                        ...
                        <label for="todo-{{$todo->id}}">{{$todo->title}}</label>
                        <span style="margin-left:1rem">{{$todo->description}}</span>
                        <span style="margin-left:1rem; margin-right:1rem;">{{$todo->date}}</span>
                        <button wire:click="delete({{$todo->id}})" type="button" style="border: 2px solid black;" class="btn danger focus:outline-none bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
                    </div>
                @endif
            </div>
        @empty
